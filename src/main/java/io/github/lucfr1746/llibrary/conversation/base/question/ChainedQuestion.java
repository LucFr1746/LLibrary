package io.github.lucfr1746.llibrary.conversation.base.question;
...
public final class ChainedQuestion<
    ...
    private final Queue<Function<ComputeContext<MessageType, SenderType>, Question<MessageType, SenderType>>> questionsFunc = new ArrayDeque<>();
