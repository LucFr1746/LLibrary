 ...
 *  - Obfuscate the code (every obfuscate should allow you to make an exception for specific files)
 *  - Reformat the code (if you use a linter, add an exception)
 *
 * Violations will result in a ban of your plugin and account from bStats.
 */
package io.github.lucfr1746.llibrary.metrics;
...
public class bStats {
    ...
    public static class MetricsBase {
         ...
         * @param skipRelocateCheck Whether the relocated check should be skipped.
         */
        public MetricsBase(
                String platform,
                String serverUuid,
            ...
            // canceled when the scheduler is shutdown.
        ...
        private void checkRelocation() {
            ...
            if (System.getProperty("bstats.relocate check") == null
                    || !System.getProperty("bstats.relocate check").equals("false")) {
                ...
                // We want to make sure no one just copies and pastes the example and uses the wrong
                // package names
     ...
     *
     * <p>While this class is neither feature-rich nor the most performant one, it's enough
     * for its use-case.
     */
